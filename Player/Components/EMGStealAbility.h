...
DECLARE_DYNAMIC_MULTICAST_DELEGATE(FOnStolenItem);
DECLARE_DYNAMIC_MULTICAST_DELEGATE(FPlayShowHOstCollisionCue);
...
public:
	...
	FOnStolenItem OnItemStolen;

	UPROPERTY(BlueprintAssignable)
	FPlayShowHOstCollisionCue OnPlayCollisionCue;
